...
## Fork Changes (YuNaga224/claude-code-action@beta)
...
- **Updated Base Action**: Uses `YuNaga224/claude-code-base-action@beta` which includes OAuth credential handling
